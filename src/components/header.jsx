...
import apw_brand from "../assets/apw_brand.png";
...
export default function NavbarActionButtonPreview() {
  ...
  return (
    <>
      ...
      <header className="sticky top-0  border-b-1 z-20 w-full bg-seccol border-b  border-slate-200 bg-white/90 shadow-lg shadow-slate-700/5 after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          >
            ...
            <a
              ...
              aria-current="page"
              className="flex items-center gap-2 whitespace-nowrap py-3 text-lg focus:outline-none lg:flex-1 overflow-clip"
              href="javascript:void(0)"
            >
              <img src={apw_brand} alt="" class="w-52 "></img>
            </a>
            {/*      <!-- Mobile trigger --> */}
            <button
            ...
            >
              <div className="absolute top-1/2 left-1/2 w-6 -translate-x-1/2 -translate-y-1/2 transform">
                <span
                  aria-hidden="true"
                  className="absolute block h-0.5 w-9/12 -translate-y-2 transform rounded-full bg-pricol transition-all duration-300"
                ></span>
                <span
                  aria-hidden="true"
                  className="absolute block h-0.5 w-6 transform rounded-full bg-pricol transition duration-300"
                ></span>
                <span
                  aria-hidden="true"
                  className="absolute block h-0.5 w-1/2 origin-top-left translate-y-2 transform rounded-full bg-pricol transition-all duration-300"
                ></span>
              </div>
            </button>
            {/*      <!-- Navigation links --> */}
            ...
            >
              <li role="none" className="flex items-stretch">
                <a
                  ...
                  aria-haspopup="false"
                  tabIndex="0"
                  className="flex items-center gap-2 py-4 transition-colors duration-300 text-pricol hover:text-slate-500 focus:bg-emerald-50 focus:outline-none focus-visible:outline-none lg:px-8"
                  href="#contact"
                >
                  <span>Contact</span>
                </a>
            ...
            <div className="hidden sm:flex ml-auto  items-center px-2 lg:ml-0 lg:p-0">
              <button
